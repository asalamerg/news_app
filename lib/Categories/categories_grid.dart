      ...
      child: Column(
        ...
        Expanded(
            child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 24,crossAxisSpacing: 24),
                 itemBuilder: (context,index)=>Shape(index: index,categoryModel:categories[index]) ,itemCount: categories.length,
